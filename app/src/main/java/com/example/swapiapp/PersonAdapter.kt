...
class PersonAdapter(private val onDeleteClick: (Person) -> Unit) : ListAdapter<Person, PersonAdapter.PersonViewHolder>(PersonDiffCallback()) {
    class PersonViewHolder(itemView: View, val onDeleteClick: (Person) -> Unit) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PersonViewHolder {
        ...
        return PersonViewHolder(view, onDeleteClick)
    }
